...
pathway_df = pd.read_csv("../../data/curatedMetagenomicData/ChngKR_2016/ChngKR_2016.pathcoverage.csv",
                         sep=',', index_col=0)
...
acc_df.to_csv("pathway/AD_search_ACC_pathway.csv", sep="\t", header=True, index=True)
auc_df.to_csv("pathway/AD_search_AUC_pathway.csv", sep="\t", header=True, index=True)
f1_df.to_csv("pathway/AD_search_f1_pathway.csv", sep="\t", header=True, index=True)
