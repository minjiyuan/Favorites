...
pathway_df = pd.read_csv("../../data/curatedMetagenomicData/KosticAD_2015/KosticAD_2015.pathcoverage.csv",
                             sep=',', index_col=0).T
...
species_df = pd.read_table("../../data/curatedMetagenomicData/KosticAD_2015/counts/KosticAD_2015_counts_species.csv",
...
acc_df.to_csv("pathway/T1D_ACC_pathway.csv",sep="\t",header=True,index=True)
auc_df.to_csv("pathway/T1D_AUC_pathway.csv",sep="\t",header=True,index=True)
f1_df.to_csv("pathway/T1D_f1_pathway.csv",sep="\t",header=True,index=True)
