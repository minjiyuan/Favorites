...
pathway_df = pd.read_csv("../../data/curatedMetagenomicData/JieZ_2017/JieZ_2017.pathcoverage.csv",
                             sep=',', index_col=0)
...
acc_df.to_csv("pathway/ACVD_ACC_pathway.csv",sep="\t",header=True,index=True)
auc_df.to_csv("pathway/ACVD_AUC_pathway.csv",sep="\t",header=True,index=True)
f1_df.to_csv("pathway/ACVD_f1_pathway.csv",sep="\t",header=True,index=True)
