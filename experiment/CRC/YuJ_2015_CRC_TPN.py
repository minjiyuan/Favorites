...
acc_df.to_csv("MixtureLoss/CRC_MixtureLoss_ACC.csv",sep="\t",header=True,index=True)
auc_df.to_csv("MixtureLoss/CRC_MixtureLoss_AUC.csv",sep="\t",header=True,index=True)
f1_df.to_csv("MixtureLoss/CRC_MixtureLoss_f1.csv",sep="\t",header=True,index=True)
