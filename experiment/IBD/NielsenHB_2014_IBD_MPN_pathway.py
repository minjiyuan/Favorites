...
pathway_df = pd.read_csv("../../data/curatedMetagenomicData/NielsenHB_2014/NielsenHB_2014.marker_presence.csv",
                             sep=',', index_col=0).T
...
acc_df.to_csv("pathway/IBD_ACC_pathway.csv",sep="\t",header=True,index=True)
auc_df.to_csv("pathway/IBD_AUC_pathway.csv",sep="\t",header=True,index=True)
f1_df.to_csv("pathway/IBD_f1_pathway.csv",sep="\t",header=True,index=True)
